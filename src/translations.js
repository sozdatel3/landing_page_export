...
export const translations = {
  en: {
    ...
    juliaPassion: "We believe dental insurance should work when you need it. Since 2002, we have focused on plans with minimal conditions, little to no waiting periods, and real Day One coverage — from cleanings and fillings to root canals, crowns, and implants. When emergencies happen, coverage should already be in place. Since introducing this product line in 2023, we have proudly served nearly 2,000 clients. Recent changes to our main association-based provider, which limited access to U.S. citizens and Green Card holders only, led us to expand our solutions so we can continue offering strong networks and meaningful coverage to more people.\n\nOn this page, you will find a carefully curated selection of plans that meet these standards. Some state and immigration limitations still apply — particularly for our flagship Delta Dental PPO 1500 plan — but we hope you will find the right fit. The page is designed for self-service, with clear plan descriptions and direct enrollment links. It is also available in Spanish, Russian, Ukrainian, and Georgian.\n\nPLEASE CONFIRM YOUR DENTIST IS IN-NETWORK BEFORE ENROLLING. IF YOU DO NOT HAVE A DENTIST, USE THE PROVIDER DIRECTORY LINK UNDER YOUR SELECTED PLAN. IN-NETWORK CARE MAXIMIZES YOUR SAVINGS.",
    // Plans section
...
Available in: AL, CA, DC, DE, FL, GA, NV, PA, TX.`,
    ...
    dentalProfessionalsAtention: `
        ...
        ru: {
            ...
            heroTitle: '🦷 Стоматологическая страховка без ожидания',
            ...
            meetJulia: "Здравствуйте! Я Юлия — независимый страховой консультант и брокер из Нью-Йорка, специализируюсь на финансовой защите клиентов.",
            juliaIntro: "Имея более 20 лет опыта в сфере финансовых услуг, я специализируюсь на страховании жизни, страховании на случай инвалидности, защите от критических и хронических заболеваний, а также на планировании долгосрочного ухода. Ещё одно особенно важное для меня направление — практичные решения в области стоматологического страхования, которые помогают людям получить доступ к важному лечению зубов без ожидания и при этом сэкономить деньги.\n\nНа основе бесчисленных разговоров с клиентами, стоматологами и собственного опыта я ясно вижу, насколько часто традиционное стоматологическое страхование вызывает разочарование из-за периодов ожидания, исключений, сложных условий и сниженных процентов покрытия именно тогда, когда помощь действительно нужна.\n\nЗа последние три года мы помогли более чем 1,000 клиентам подобрать варианты стоматологического страхования, которые могут поддерживать профилактические, базовые и major-услуги, включая сложные процедуры, в зависимости от структуры плана и индивидуального права на участие.",
            juliaPassion: "Мы уверены, что стоматологическая страховка должна работать именно тогда, когда она вам нужна. С 2002 года мы сосредоточены на планах с минимальными условиями, с небольшими или вовсе отсутствующими периодами ожидания и с реальным покрытием с первого дня — от чисток и пломб до лечения каналов, коронок и имплантов. Когда случаются экстренные ситуации, покрытие уже должно действовать. С момента запуска этой линейки продуктов в 2023 году мы с гордостью обслужили почти 2,000 клиентов. Недавние изменения у нашего основного ассоциированного провайдера, который ограничил доступ только гражданами США и обладателями Green Card, побудили нас расширить набор решений, чтобы мы и дальше могли предлагать сильные сети и meaningful coverage большему числу людей.\n\nНа этой странице вы найдёте тщательно отобранную подборку планов, соответствующих этим стандартам. Некоторые ограничения по штатам и иммиграционному статусу всё ещё действуют — особенно для нашего флагманского плана Delta Dental PPO 1500, — но мы надеемся, что вы найдёте подходящий вариант. Страница создана для самостоятельного оформления, с понятными описаниями планов и прямыми ссылками на регистрацию. Она также доступна на испанском, русском, украинском и грузинском языках.\n\nПОЖАЛУЙСТА, УБЕДИТЕСЬ, ЧТО ВАШ СТОМАТОЛОГ ВХОДИТ В СЕТЬ, ПЕРЕД РЕГИСТРАЦИЕЙ. ЕСЛИ У ВАС ЕЩЁ НЕТ СТОМАТОЛОГА, ИСПОЛЬЗУЙТЕ ССЫЛКУ НА КАТАЛОГ ВРАЧЕЙ ПОД ВЫБРАННЫМ ПЛАНОМ. ЛЕЧЕНИЕ В СЕТИ МАКСИМИЗИРУЕТ ВАШУ ЭКОНОМИЮ.",
            // Plans section
...
<br>🔹 <strong>MetLife Dental:</strong> 1-800-275-4638`,
            ...
            sharedList: [
                ...
                "✔️ Доступны варианты БЕЗ ПЕРИОДА ОЖИДАНИЯ",
                "✔️ Есть планы, покрывающие импланты и дорогостоящее лечение"
            ],
            
            metlifeTitle: "🦷 MetLife PPO Platinum (PDP Network)",
            metlifeSubTitle: "До $3,000 годового максимума. 12-месячный период ожидания на major-услуги. Нет исключения по отсутствующему зубу.<br>Недоступен в: AK, ID, LA, ME, MD, MT, NH, NM, OR, SD, WA.",
            metlifeFeatures: [
                { text: "Покрытие", sub: [
                    "100% Профилактика — чистки, осмотры, рентген",
                    "80% Базовые услуги — пломбы, удаления, пародонтологическое лечение",
                    "50% Major (после 12 месяцев) — коронки, лечение каналов, хирургия, импланты"
                ]},
                "Eligibility и стоимость зависят от ZIP-кода",
                "Личный кабинет: MetLife.com (обычно доступен через 7-15 дней после даты начала действия)",
                "Исключение по отсутствующему зубу: отсутствует",
                "Стоимость: примерно $96-$133 в месяц",
                "Низкий deductible"
            ],
            juliaRecommendationMetlife: `PDF: <a href="/MetLife Dental Plan Summary.pdf" target="_blank" rel="noopener noreferrer" class="plan-summary-link">Полное описание плана</a><br><br>Лучше всего подходит для сильного профилактического и пародонтологического покрытия с первого дня и более высокого годового максимума для долгосрочного планирования major-лечения.`,
...
<br>🔹 <strong>Eligibility и benefits:</strong> Delta Dental, <strong>1-877-759-5726</strong>.`,
            ...
            deltaPremierSubTitle: `$3,000 годовой максимум. Без ожидания на major-услуги. Импланты не покрываются.
Доступно в: AL, CA, DC, DE, FL, GA, NV, PA, TX.`,
            deltaPremierFeatures: [
                ...
                "Период ожидания: отсутствует",
                "Missing tooth clause: применяется (кроме Калифорнии)",
                "Стоимость: примерно от $55+/мес.",
                "$100 deductible в год на человека",
                "$35 регистрационный сбор (не возвращается)",
                "Для отмены требуется уведомление за 30 дней"
            ],
            juliaRecommendationDeltaPremier:
                `PDF: <a href="/Delta Dental PPO Plus Premier Plan Limitations EN RU.pdf" target="_blank" rel="noopener noreferrer" class="plan-summary-link">Полное описание плана</a><br><br>Лучше всего подходит для немедленного покрытия major-процедур, таких как лечение каналов, коронки, удаления и мосты. Импланты не покрываются.`,

            deltaNoWaitSubTitle: `$2,000 годовой максимум. Импланты включены. Без ожидания.
Доступно в: AL, CA, DC, DE, FL, GA, NV, PA, TX.`,
            deltaNoWaitFeatures: [
                { text: "Покрытие", sub: [
                    "80-100% Профилактика — чистки, осмотры, рентген",
                    "50-80% Базовые услуги — пломбы, удаления",
                    "50% Major — лечение каналов, коронки, импланты, мосты, хирургия"
                ]},
                "Импланты: включены",
                "Период ожидания: отсутствует",
                "Missing tooth clause: применяется (кроме Калифорнии)",
            ...
            juliaRecommendationNoWait:
                `PDF: <a href="/No_Wait_Plan_PPO_Limitation_EN.pdf" target="_blank" rel="noopener noreferrer" class="plan-summary-link">Полное описание плана</a><br><br>Лучше всего подходит для немедленного покрытия имплантов и комплексного стоматологического лечения. Если вы живёте не в Калифорнии, обязательно ознакомьтесь с Missing Tooth Clause.`,
            ...
            finalNote:
                "💙 Финальная заметка<br>Мы выбрали эти планы, потому что на протяжении многих лет именно они чаще всего оказывались наиболее разумными для большинства наших клиентов и стоматологов. Если другой вариант подходит вам лучше, вы всегда можете изучить дополнительные планы.<br>👉 Пожалуйста, внимательно ознакомьтесь с условиями, используйте ссылки на регистрацию соответствующего источника и выберите вариант, который лучше всего соответствует вашим потребностям.<br>— Юлия Баринова",
            ...
            coverageExplanation: [
                "📌 Покрытие 100% (профилактика), 80% (базовые услуги) и 50% (major-услуги) рассчитывается на основе согласованного тарифа in-network для каждой стоматологической процедуры.",
                "👩‍⚕️ Стоматологи в сети обязаны придерживаться заранее согласованных тарифов между ними и страховщиком, и ваша доля рассчитывается именно от этих сниженных ставок.",
                "❗ Лечитесь вне сети? Можно ожидать несколько более высоких счетов и больших расходов из собственного кармана. Возможность обратиться вне сети полезна, если ваш любимый стоматолог не участвует в сети. Обычно вы всё равно экономите заметно больше, чем при оплате наличными.",
                "👉 Когда выбираете нового стоматолога, постарайтесь заранее подтвердить, что он входит в сеть вашего плана, чтобы избежать неожиданных счетов."
            ],
            ...
            afterEnrollmentContent: [
                ...
                "Для Elevate Wellness / Corenroll (Источник 1): после регистрации создайте аккаунт на corenroll.com.",
                "Для Morgan White / Benefits Association (Источник 2): вы получите информацию от Morgan White.",
                "Создайте личный кабинет страховой компании (MetLife или Delta Dental), чтобы отслеживать льготы после выпуска вашего ID (обычно к началу действия покрытия)."
            ],
            ...
            ewaDescription: "*Elevate Wellness Association (EWA) — национальная организация, основанная в 1993 году, которая помогает малым и средним компаниям, самозанятым лицам, отдельным лицам и семьям по всей Америке получить доступ к групповым медицинским и велнес-льготам, которые обычно доступны только крупным работодателям. Вы можете выбрать среди следующих важных льгот:",
            ewaBenefits: [
                "Зрение, медицина, страхование жизни, несчастные случаи",
                "Госпитальная компенсация и критические заболевания",
                "Телемедицина и wellness-программы"
            ],
            ...
            testimonialMore: "Подробнее",
            testimonialLess: "Свернуть",
            ...
            contactIntro: "📢 Приглашаю вас связаться со мной и записаться на бесплатную консультацию, чтобы обсудить ваше страховое планирование — включая защиту себя и близких с помощью страхования жизни с Living Benefits, покрытия на случай инвалидности, Long Term Care и любых других вопросов, которые у вас могут быть. Прожив и проработав в США почти 30 лет, я с радостью поддерживаю новых иммигрантов ценной информацией и ресурсами, которые помогают им строить лучшую жизнь.",
            thankYou: "Спасибо за ваш интерес и сотрудничество.",
            contactInfo: {
                ...
                email: "julia@juliabarinova.com",
                calendar: "calendly.com/jbarinova",
                reviewsText: "Посмотрите наши Google Reviews, включая отзывы по стоматологическим планам:",
...
💙 Наша мета — допомогти вам отримати потрібну стоматологічну допомогу без довгих очікувань, зайвих складнощів та з економією коштів.`,
            ...
            // Testimonials
              ...
              testimonialMore: "Детальніше",
              testimonialLess: "Згорнути",
...
💙 ჩვენი მიზანია დაგეხმაროთ საჭირო სტომატოლოგიური დახმარების მიღებაში ეფექტურად — ხანგრძლივი ლოდინის გარეშე, ზედმეტი უსიამოვნებების გარეშე და თანხის დაზოგვით.`,
  ...
  ewaBenefits: [
      ...
      "ტელემედიცინა და კეთილდღეობის პროგრამები"
            ...
            testimonialMore: "მეტი",
            testimonialLess: "ნაკლები",
...
💙 Maqsadimiz — sizga kerakli dental yordamni uzoq kutishlarsiz, ortiqcha ovora bo‘lmasdan va pul tejagan holda olishga yordam berish.`,
  ...
  testimonialMore: "Ko'proq",
  testimonialLess: "Kamroq",
